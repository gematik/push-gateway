...
interface JmsConsumer {
  ...
  fun processPlainNotification(payload: PlainNotificationMessage, message: Message)

  fun processEncryptedNotification(payload: EncryptedNotificationMessage, message: Message)
}
